...
\begin{itemize}
    ...
    en la Figura \ref{fig:ucb_histograma2}. 
\end{itemize}

\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{resources/ucb_histograma.png}
\caption{Histograma de selección de brazos con distribución Normal.}
\label{fig:ucb_histograma1}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{resources/ucb2_histograma.png}
\caption{Histograma de selección de brazos con distribución Normal para distintos parámetros en el algoritmo UCB2.}
\label{fig:ucb_histograma2}
\end{figure}
...
a los obtenidos en el Normal, mientras que con Bernoulli las recompensas acumuladas son más bajas y los regrets suben considerablemente, 
por la mayor dificultad del problema.
...
\begin{itemize}
    ...
    \item La elección adecuada $\alpha$ para UCB2, es crucial para obtener un buen rendimiento con este algoritmo. A pesar de que sus cotas asintóticas son las mejores, en las duraciones de experimento que hemos usado es un 
...
\begin{itemize}
    ...
    rápidamente. En el análisis global comparativo, UCB2 se posicionó como la estrategia óptima, 
...
en la cota superior de confianza (especialmente UCB2 gracias a su optimización mediante épocas) 
superan sistemáticamente a los métodos basados en probabilidad pura o exploración aleatoria constante.
